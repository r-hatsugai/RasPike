...
S32 Scene4_pid(S32 diff_brightness,int edge, HSV out)
{
    ...
    if(edge == -1){
        left_motor_power  = (S32)(BASE_SPEED + (pid * LEFT_EDGE)-25); // int -27
        right_motor_power = (S32)(BASE_SPEED - (pid * LEFT_EDGE)-25);//steering_amount -27
    }else if(edge == 1){
        left_motor_power  = (S32)(BASE_SPEED + (pid * RIGHT_EDGE)-27); // int -27
        right_motor_power = (S32)(BASE_SPEED - (pid * RIGHT_EDGE)-27);//steering_amount -27
    }
